...
if __name__ == '__main__':
    ...
    filter_condition = 'src host 192.168.178.130 or dst 192.168.178.130'
    i = 0
    while True:
        print('i : >>>>>>>>>>>>>>> ', i)
        ...
        if elapsed_time < 1.5:
            ...
            for pred_lb , pred_count in predict_val.items():
                if pred_count > 50 and "DNS_Spoofing" in pred_lb:
                    print('Phát hiện bị tấn công : ', pred_lb)
        # if elapsed_time < 1.5 :
        #     for pred_lb, pred_count in predict_val.items():
        #         if pred_count > 200 and "DDoS" in pred_lb or "DoS" in pred_lb :
        #             print('Phát hiện tấn công : ', pred_lb)
        # else :
        #     for pred_lb, pred_count in predict_val.items():
        #         if pred_count > 500 and "BenignTraffic" not in pred_lb :
        #             print('Phát hiện tấn công : ', pred_lb)
        i +=1